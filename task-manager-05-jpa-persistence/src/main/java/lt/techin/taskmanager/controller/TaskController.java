...
public class TaskController {
    ...
    @GetMapping("/search")
    public List<TaskResponse> searchByDone(@RequestParam boolean done) {
        List<Task> tasks = taskService.searchByDone(done);
        return taskMapper.toResponseList(tasks);
    }
    ...
    public ResponseEntity<TaskResponse> updateDone(@PathVariable Long id, @RequestParam boolean value) {
        Task updatedTask = taskService.updateDone(id, value);
        return ResponseEntity.ok(taskMapper.toResponse(updatedTask));
    }
